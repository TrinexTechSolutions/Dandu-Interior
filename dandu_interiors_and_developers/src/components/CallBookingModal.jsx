      ...
      {isCallModalOpen && (
        <div className="fixed inset-0 z-[160] flex items-end md:items-center justify-center" data-lenis-prevent>
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl h-[88dvh] md:h-[80vh] bg-[#F8F5F2] rounded-t-[32px] md:rounded-[32px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col md:flex-row m-0 md:m-4"
            drag="y"
