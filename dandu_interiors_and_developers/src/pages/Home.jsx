  ...
  return (
    <>
      ...
      <div className="bg-[#F8F5F2] overflow-hidden">
        ...
        {/* About Section - Staggered Editorial Layout */}
        <SectionWrapper bgClass="bg-[#F8F5F2]" id="about-intro" paddingClass="py-12 md:py-20">
          <div className="max-w-[1400px] mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">

              {/* Left Column: Context */}
              <div className="lg:col-span-7">
                <h2 className="text-[#37302F]/40 text-[10px] font-bold tracking-[0.4em] uppercase mb-6 flex items-center gap-4">
                  <span className="w-8 h-px bg-[#37302F]/30 block"></span> About Our Firm
                </h2>
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-light tracking-tighter text-[#1A1A1A] mb-6 leading-[0.95]">
                  <span className="block sm:whitespace-nowrap">Bringing Your Dream</span>
                  <span className="block italic font-serif text-black/30">Home to Life.</span>
                </h2>
                <p className="text-[#1A1A1A]/70 text-base md:text-lg font-light leading-relaxed max-w-2xl">
                  Dandu Interiors & Developers is committed to delivering high-quality construction and interior services. Through timely execution, reliability, and dedicated teamwork, we transform your aspirations into structurally sound and beautifully crafted realities.
                </p>
              </div>

              {/* Right Column: Staggered Stats (Side-by-side on Mobile) */}
              <div className="lg:col-span-5 relative flex items-center justify-center lg:justify-end mt-12 lg:mt-0">
                <div className="w-full max-w-[500px] flex flex-row items-center justify-between lg:block lg:relative">

                  {/* Stat 1: Premium Projects */}
                  <div className="relative lg:absolute lg:-top-32 lg:left-0 md:lg:-left-8 z-10 transition-transform duration-1000 flex flex-col items-start">
                    <div className="text-6xl sm:text-7xl md:text-8xl lg:text-[9.5rem] font-light text-[#37302F] leading-none tracking-tighter">
                      <CountUp end={30} suffix="+" />
                    </div>
                    <div className="text-[9px] sm:text-[10px] font-bold tracking-[0.2em] sm:tracking-[0.3em] uppercase text-[#37302F]/50 mt-2">
                      Projects Completed
                    </div>
                  </div>

                  {/* Stat 2: Years of Mastery */}
                  <div className="relative lg:absolute lg:top-8 lg:right-0 md:lg:-right-4 transition-transform duration-1000 flex flex-col items-end lg:items-start">
                    <div className="text-6xl sm:text-7xl md:text-8xl lg:text-[9.5rem] font-light text-[#37302F]/50 leading-none tracking-tighter italic font-serif text-right lg:text-left">
                      <CountUp end={5} suffix="+" />
                    </div>
                    <div className="text-[9px] sm:text-[10px] font-bold tracking-[0.2em] sm:tracking-[0.3em] uppercase text-[#37302F]/50 mt-2 text-right lg:text-left">
                      Years of Experience
                    </div>
                  </div>

                  {/* Decorative background element for the stats */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-[#37302F]/5 rounded-full blur-2xl -z-10 hidden lg:block"></div>
                </div>
              </div>
